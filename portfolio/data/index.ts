...
export const gridItems = [
  ...
  {
    id: 5,
    title: "Currently building a React Component Animation library",
  ...
  {
    id: 6,
    title: "Hit in your console or terminal to connect with me.",
    description: "",
    className: "lg:col-span-2 md:col-span-3 md:row-span-1",
    imgClassName: "",
...
export const testimonials = [
  {
    quote:
      "Collaborating with Manthan was an absolute pleasure. His professionalism, promptness, and dedication to delivering exceptional results were evident throughout our project. Manthan's enthusiasm for every facet of development truly stands out. If you're seeking to elevate your website and elevate your brand, Manthan is the ideal partner.",
